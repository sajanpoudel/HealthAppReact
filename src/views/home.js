        ...
        <div className="featuresContainer">
          <div className="home-features1">
            ...
            <div className="home-container03">
              <FeatureCard
                heading="Dark Theme"
                subHeading="Switch to a sleek and modern dark theme for a more immersive experience."
              ></FeatureCard>
              <FeatureCard
                heading="Light Theme"
                subHeading="Prefer a brighter look? Switch to the light theme for a clean and refreshing interface."
              ></FeatureCard>
              <FeatureCard
                heading="Comprehensive Health Insights"
                subHeading="Get access to a wide range of health insights, including vital signs, activity tracking, sleep analysis, and more."
              ></FeatureCard>
              <FeatureCard
                heading="User-Friendly Dashboard"
                subHeading="Enjoy a user-friendly dashboard that presents your health data in a clear and intuitive manner."
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                answer="The health dashboard application provides users with all the health insights they need in one place."
                question="What is the purpose of the health dashboard application?"
              ></Question1>
              <Question1
                answer="Yes, the health dashboard application offers both dark and light themes for customization."
                question="Can I customize the theme of the health dashboard?"
              ></Question1>
              <Question1
                answer="The health dashboard application provides a wide range of health insights including fitness data, sleep patterns, heart rate monitoring, and more."
                question="What kind of health insights does the dashboard provide?"
              ></Question1>
              <Question1
                answer="Yes, the health dashboard application can sync and integrate data from various health tracking devices for a comprehensive overview of your health."
                question="Is the health dashboard application compatible with other health tracking devices?"
              ></Question1>
              <Question1
                answer="Yes, the health dashboard application is accessible on multiple devices including smartphones, tablets, and computers."
                question="Can I access the health dashboard application on multiple devices?"
              ></Question1>
            </div>
          </div>
        </div>
